...
public class MainGameLoop {
	...
	public static void main(String[] args) {
		...
		FontType font = new FontType(loader.loadTexture("UIFontHQ"), new File("res/UIFontHQ.fnt"));
		GUIText text = new GUIText("I am bad!", 3, font, new Vector2f(0f, 0.2f), 1f, true);
		...
		while (!Display.isCloseRequested()) {
			...
			text.setTextString(String.format("%.2f", DisplayManager.getFPS()));
